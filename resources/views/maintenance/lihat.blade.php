                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('formperbaikans.update', $formperbaikan->id) }}" method="POST" enctype="multipart/form-data" onsubmit="handleFormSubmission(event)">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="tindak_lanjut" name="tindak_lanjut" rows="3" value="{{ $formperbaikan->tindak_lanjut }}" disabled>{{ $formperbaikan->tindak_lanjut }}</textarea>
                                </div>

                                <div class="mb-3">
                                    <label for="due_date" class="form-label">Due Date</label>
                                    <input type="date" class="form-control" id="due_date" name="due_date" value="{{ $formperbaikan->due_date }}" disabled>
                                </div>

                                <div class="mb-3">
                                    <label for="schedule_pengecekan" class="form-label">Schedule Pengecekan</label>
                                    <input type="text" class="form-control" id="schedule_pengecekan" name="schedule_pengecekan" value="{{ $formperbaikan->schedule_pengecekan }}" disabled>
                                </div>
